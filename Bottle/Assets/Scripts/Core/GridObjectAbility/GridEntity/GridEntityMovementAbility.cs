...
//    {
//        [OnInspectorGUI("GetPathCreator")]
//        public PathCreator.PathCreatorReference pathCreatorReference = new PathCreator.PathCreatorReference();
...
//            GetPathCreator();
//        }
//        private void GetPathCreator()
//        {
//            if (currentAssignedPathCreator == null)
//                currentAssignedPathCreator = default(PathCreator);

//            if (currentAssignedPathCreator != null)
//                currentAssignedPathCreator = this.pathCreatorReference;
//        }
...
//            //{
//            //    if (__currentGridObject.isControllable)
//            //    {
//            //        __currentGridObject.isControllable = false;
//            //    }
//            //    else
//            //        __currentGridObject.isControllable = true;
//            //}
//        }
...
//            //Vector3Int blockableGridObjectPosition = new Vector3Int(__currentGridObject.gridPosition.x, (int)__currentGridObject.gridHeight, __currentGridObject.gridPosition.y) + GetValueFromDirection(theDirection, GameplayManager.Instance.globalFrontDirection);
...
//            Vector3 newPosition = Vector3.MoveTowards(_currentGridObject.transform.position, destination, Time.deltaTime * currentSpeed);
//            if (_currentGridObject.transform.position != newPosition)
//            {
//                _currentGridObject.transform.position = newPosition;
//                _isMoving = true;
//                GameplayManager.Instance.isTurnInProgress = true;
//            }
//            else
//            {
//                var gridPos = GridManager.Instance.ConvertWorldPositionToGridPosition(_currentGridObject);
//                _currentGridObject.gridPosition = new Vector2Int(gridPos.x, gridPos.z);
//                _currentGridObject.gridHeight = gridPos.y;
...
//        {
//            Vector3 currentChildRotationEulerAngle = _currentGridObject.transform.rotation.eulerAngles;
//            switch (globalDirection)
//            {
//                case GameplayManager.GlobalDirection.POSITIVE_Z:
//                    if (targetDirection == MovementDirections.FORWARD)
//                    {
//                        _currentGridObject.transform.RotateAround(_currentGridObject.transform.position, _currentGridObject.transform.parent.up, 0 - currentChildRotationEulerAngle.y);
//                    }
//                    else if (targetDirection == MovementDirections.BACK)
//                    {
//                        _currentGridObject.transform.RotateAround(_currentGridObject.transform.position, _currentGridObject.transform.parent.up, 180 - currentChildRotationEulerAngle.y);
//                    }
//                    else if (targetDirection == MovementDirections.LEFT)
//                    {
//                        _currentGridObject.transform.RotateAround(_currentGridObject.transform.position, _currentGridObject.transform.parent.up, -90 - currentChildRotationEulerAngle.y);
//                    }
