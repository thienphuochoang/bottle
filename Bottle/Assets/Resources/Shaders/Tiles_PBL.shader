	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				float2 uv_Base = IN.ase_texcoord9.xy * _Base_ST.xy + _Base_ST.zw;
				float2 uv2_Layer = IN.ase_texcoord9.zw * _Layer_ST.xy + _Layer_ST.zw;
				float4 tex2DNode4 = tex2D( _Layer, uv2_Layer );
				float3 lerpResult9 = lerp( ( (_Color).rgb * (tex2D( _Base, uv_Base )).rgb ) , (tex2DNode4).rgb , tex2DNode4.a);
				
				float2 uv_Normal_Map = IN.ase_texcoord9.xy * _Normal_Map_ST.xy + _Normal_Map_ST.zw;
				
				o.Albedo = lerpResult9;
		...
		Pass
		{
				...
				) : SV_Target 
			{
				...
				float2 uv2_Layer = IN.ase_texcoord3.zw * _Layer_ST.xy + _Layer_ST.zw;
				float4 tex2DNode4 = tex2D( _Layer, uv2_Layer );
				float3 lerpResult9 = lerp( ( (_Color).rgb * (tex2D( _Base, uv_Base )).rgb ) , (tex2DNode4).rgb , tex2DNode4.a);
...
WireConnection;18;5;23;0
ASEEND*/
//CHKSM=F52EFE1C7340738401B6E588E2E154502ED924C7